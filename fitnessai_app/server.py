...
#from models_integration import fetch_photos_from_mongodb,analyse_xgboost_photos_mock, analyse_sarima_photos_mock,analyse_CNN_photos_mock
...
def analyze():
    ...
    try:
        thread = Thread(target = analyze_in_background, args = (None, training_id))
        thread.start()
    except Exception as e:
        print(e)
